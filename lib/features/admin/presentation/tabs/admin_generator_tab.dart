...
class _AdminGeneratorTabState extends State<AdminGeneratorTab> {
          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                items: widget.data.classTypes.map((t) => DropdownMenuItem(value: t.id, child: Text(t.name))).toList(),
                ...
                children: [
                  Expanded(
                    ...
                    child: DropdownButtonFormField<String>(
                      ...
                      items: widget.data.instructors.map((u) => DropdownMenuItem(value: u.userId, child: Text("${u.firstName} ${u.lastName}"))).toList(),
  ...
  Widget _buildDayChip(String label, int dayIndex) {
    ...
    return FilterChip(
      ...
      onSelected: (bool selected) {
        setState(() {
          selected ? _selectedWeekDays.add(dayIndex) : _selectedWeekDays.remove(dayIndex);
        });
      },
  ...
  void _submit({bool force = false}) {
    ...
    final selectedType = widget.data.classTypes.firstWhere((t) => t.id == _selectedClassTypeId);
    final selectedInstructor = widget.data.instructors.firstWhere((u) => u.userId == _selectedInstructorId);
