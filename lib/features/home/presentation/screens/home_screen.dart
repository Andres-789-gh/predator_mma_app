...
class HomeScreen extends StatelessWidget {
  ...
  Widget _buildPlanCard(BuildContext context, UserPlan plan, bool isDark) {
    ...
    final bool isPlanPaused = plan.isPaused(now);
    final bool isPlanActiveVisual = !isPlanExpired && !isPlanPaused;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 10),
          Text(
            'Vence: ${plan.endDate.day}/${plan.endDate.month}/${plan.endDate.year}',
            style: TextStyle(color: !isDark ? Colors.grey[700] : Colors.grey),
          ),
          const SizedBox(height: 5),
          if (plan.remainingClasses != null) ...[
            ...
            const SizedBox(height: 8),
            Text(
              '${plan.remainingClasses} clases disponibles',
              style: TextStyle(
            ...
            if (plan.consumptionType == PlanConsumptionType.limitedDaily)
              Text(
                'Límite: ${plan.dailyLimit ?? 1} clase(s) por día',
                style: TextStyle(
                  color: !isDark ? Colors.grey[800] : Colors.white70,
                ),
              )
